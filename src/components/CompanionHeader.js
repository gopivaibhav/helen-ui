...
const CompanionHeader = ({ setIsActive, progress }) => {
  ...
  return (
    <>
      ...
      {/* {showRatingModal && ( */}
      {/* <SessionRating setShowRatingModal={setShowRatingModal} /> */}
      {/* )} */}
    </>
  );
};
